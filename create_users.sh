...
#Här börjar själva for loopen med lista som lagrar användare som läggs in som argument. Listan skapar ett home directory för varje användare och skapar sedan nödvändiga underliggande mappar. Därefter ändras ägarskapet av mappen till användaren och rwx rättigheter sätts efteråt. Till slut skapas en .txt fil med välkomstmeddelande
for user in "$@"; do
  useradd -m $user
